                    ...
                    <li>
                      <a class="np-btn" href="#"><i class="fa fa-angle-right pagination-right"></i></a>
								...
								<div class="table-inbox-wrap ">
											...
											<tbody>
												...
												<tr class="inbox-small-cells">
													...
													<td class="view-message dont-show"><a
														href="ShowMessage?id_mess=<%=listMessage.get(i).getid()%>">
															<%
																String name = "";
													...
													<td class="view-message"><a
														href="ShowMessage?id_mess=<%=listMessage.get(i).getid()%>"><%=listMessage.get(i).gettitle()%></a></td>
													<td class="view-message inbox-small-cells"><a
														href="ShowMessage?id_mess=<%=listMessage.get(i).getid()%>"></a></td>
									...
									<form action="Authenticate" name="refesh" id="refesh"
										method="POST"></form>
								</div>
							</div>
						</section>
